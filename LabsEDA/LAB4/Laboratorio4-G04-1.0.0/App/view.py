...
def main():
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            if result == None:
                print("El usuario no se encuentra en la cola para leer el ibro indicado")
            else:
                print("La posición del usuario ", user_id, " en la cola para leer el libro ", book_id , " es: ", result)
