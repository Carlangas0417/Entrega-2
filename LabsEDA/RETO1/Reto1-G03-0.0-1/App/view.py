...
def print_req_2(control):
    ...
    datos=log.req_2(control,dep)
    print("El último registro de ese departamento es: ",datos[0])
    print("Un total de: ", datos[2], " registros pasaron el filtro de busqueda.")
    print("La acción tomó: ", datos[1], "ms")
...
def print_req_5(control):
    ...
    anno_i=input("Inserte año inicial: ")
...
def print_req_6(control):
    ...
    fecha_i=input("Inserte el año inicio: ")
    fecha_f=input("Inserte el año final: ")
    dep=input("Inserte el nombre del departamento de interés: ")
    datos=log.req_6(control,fecha_i,fecha_f,dep)
    
    print("Registros en el departamento dentro del rango dado: ",datos[0])
    print("...")
    print("Registros con base SURVEY: ", datos[1])
    print("...")
    print("Registros con base CENSUS: ", datos[2])
    print("...")
    print("Un total de: ", datos[3], " registros pasaron el filtro de busqueda.")
    print("...")
    print("La acción tomó: ", datos[4],"ms")
...
def print_req_7(control):
    ...
    fecha_f=input("Inserte el año final: ")
    dep=input("Inserte el nombre del departamento de interés: ")
    datos=log.req_7(control,fecha_i,fecha_f,dep)
    
    print("Un total de: ", datos[0], " registros pasaron el filtro de busqueda.")
    print("...")
    print("Para el periodo MAYOR, se encontro: ", datos[1])
    print("...")
    print("Para el periodo MENOR , se encontro: ", datos[2])
    print("...")
    print("La acción tomó: ", datos[3],"ms")
